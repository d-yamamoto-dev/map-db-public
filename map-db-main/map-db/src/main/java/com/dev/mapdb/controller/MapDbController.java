...
public class MapDbController {
    ...
    public String displayBuildingInfoAddForm(Model model, @RequestParam(name = "lat", required = true) String lat,
    ...
    public String displayBuildingInfo(@PathVariable String buildingId, Model model) {
